    ...
    <div class="row">
        <div class="col-md-4 col-xs-12">
          ...
          <div class="row between-xs middle-xs">
            ...
            <div class="dots">
              @php(printDots(get_field('athletics')))
            </div>
          </div>
          <div class="row between-xs middle-xs">
            <label>Brawl</label>
            <div class="dots">
              @php(printDots(get_field('brawl')))
            </div>
          </div>
          <div class="row between-xs middle-xs">
            <label>Drive</label>
            <div class="dots">
              @php(printDots(get_field('drive')))
            </div>
          </div>
          <div class="row between-xs middle-xs">
            <label>Firearms</label>
            <div class="dots">
              @php(printDots(get_field('firearms')))
            </div>
          </div>
          <div class="row between-xs middle-xs">
            <label>Larceny</label>
            <div class="dots">
              @php(printDots(get_field('larceny')))
            </div>
          </div>
          <div class="row between-xs middle-xs">
            <label>Stealth</label>
            <div class="dots">
              @php(printDots(get_field('stealth')))
            </div>
          </div>
          <div class="row between-xs middle-xs">
            <label>Survival</label>
            <div class="dots">
              @php(printDots(get_field('survival')))
            </div>
          </div>
          <div class="row between-xs middle-xs">
            <label>Weaponry</label>
            <div class="dots">
              @php(printDots(get_field('weaponry')))
            </div>
          </div>
          <h4>Social</h4>
          <div class="row between-xs middle-xs">
            ...
            <div class="dots">
              @php(printDots(get_field('animal_ken')))
            </div>
          </div>
          <div class="row between-xs middle-xs">
            <label>Empathy</label>
            <div class="dots">
              @php(printDots(get_field('empathy')))
            </div>
          </div>
          <div class="row between-xs middle-xs">
            <label>Expression</label>
            <div class="dots">
              @php(printDots(get_field('expression')))
            </div>
          </div>
          <div class="row between-xs middle-xs">
            <label>Intimidation</label>
            <div class="dots">
              @php(printDots(get_field('intimidation')))
            </div>
          </div>
          <div class="row between-xs middle-xs">
            <label>Persuasion</label>
            <div class="dots">
              @php(printDots(get_field('persuasion')))
            </div>
          </div>
          <div class="row between-xs middle-xs">
            <label>Socialize</label>
            <div class="dots">
              @php(printDots(get_field('socialize')))
            </div>
          </div>
          <div class="row between-xs middle-xs">
            <label>Streetwise</label>
            <div class="dots">
              @php(printDots(get_field('streetwise')))
            </div>
          </div>
          <div class="row between-xs middle-xs">
            <label>Subterfuge</label>
            <div class="dots">
              @php(printDots(get_field('subterfuge')))
            </div>
          </div>
        </div>
        <div class="col-md-4 col-xs-12">
