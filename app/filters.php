...
$mailHeader = `<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
  ...
  <tr>
    <td align="center" valign="top" bgcolor="#333333" style="background-color: #333333;">
      ...
      <table border="0" width="600" cellpadding="0" cellspacing="0" class="container" style="width:600px;max-width:600px">
        <tr>
          <td class="container-padding header" align="left" style="font-family:Helvetica, Arial, sans-serif;font-size:24px;font-weight:bold;padding-bottom:12px;color:#fff5a3;padding-left:24px;padding-right:24px">
            SOLACE
          </td>
        </tr>
        <tr>
          <td class="container-padding content" align="left" style="padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:12px;background-color:#333333; border: 3px #FFF solid;">
            <br>
`;
...
$mailFooter = `</td>
        ...
        <tr>
          <td class="container-padding footer-text" align="left" style="font-family:Helvetica, Arial, sans-serif;font-size:12px;line-height:16px;color:#fff5a3;padding-left:24px;padding-right:24px">
            <br /><br />
            <a href="https://solacelarp.com/" style="color:#fff5a3">solacelarp.com</a><br>
...
$titleStart = `<div class="title" style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;color:#fff5a3;">`;
$titleEnd = `</div>
<br>`;

$bodyStart = `<div class="body-text" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:20px;text-align:left;color:#fff5a3">`;
$bodyEnd = `<br><br>
</div>`;
